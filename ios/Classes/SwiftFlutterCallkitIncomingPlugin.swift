...
public class SwiftFlutterCallkitIncomingPlugin: NSObject, FlutterPlugin, CXProviderDelegate {
    ...
    public func provider(_ provider: CXProvider, perform action: CXSetHeldCallAction) {
        ...
        self.sendEvent(SwiftFlutterCallkitIncomingPlugin.ACTION_CALL_TOGGLE_HOLD, [ "id": action.callUUID.uuidString, "isOnHold": action.isOnHold,"handle": call.handle ])
        action.fulfill()
    }
    ...
    public func provider(_ provider: CXProvider, perform action: CXSetMutedCallAction) {
        ...
        self.sendEvent(SwiftFlutterCallkitIncomingPlugin.ACTION_CALL_TOGGLE_MUTE, [ "id": action.callUUID.uuidString, "isMuted": action.isMuted , "handle": call.handle ])
        action.fulfill()
    }
